...
fixture("Document Preview View").page`http://localhost:3010`; // eslint-disable-line mdx/no-unused-expressions
...
test("document preview is rendered correctly with correct data", async (t: TestController) => {
